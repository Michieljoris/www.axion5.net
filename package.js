...
module.exports = {
    ...
    "homepage": "https://github.com/michieljoris/blog-example",
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/blog-example.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/blog-example/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called blog which is linked to
    //./bin/blog in the local package.

    //If we have installed this package globally using npm install blog
    //-g we will be able to call this new command blog from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/blog.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/blog.js"
    }
};
